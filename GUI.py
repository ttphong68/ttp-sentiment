...
#----------------------------------------------------------------------------------------------------
    ...
    # menu = ["Nhập bình luận", "Tải tệp Excel", "Tải tệp CSV", "Tải tệp âm thanh", "Bình luận bằng giọng nói", "Nói chuyện với chatGPT"]
    menu = ["Nhập bình luận", "Tải tệp Excel", "Tải tệp CSV", "Tải tệp âm thanh", "Bình luận bằng giọng nói"]
...
#------------------------------------------------------------------------------------------------------------------    
        ...
        def record_audio():
            ...
            CHANNELS = 2
            RATE = 44100
            RECORD_SECONDS = 5 # Số giấy ghi ấm
        ...
        def transcribe_audio(audio_file):
            ...
            try:
                ...
                st.error("Sorry, there was an error with the speech recognition service. Please try again later.")
    ...
    #         else:
    #             st.write('Câu bình luận của bạn :'+text)
    #             st.write('Bạn vui lòng chờ chút! :'+text)
    #             result= chatGPT(text)
